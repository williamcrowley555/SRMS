                                                        ...
                                                        foreach($results as $result)
                                                            {   ?>
                                                                <tr>
                                                                   ...
                                                                   <?php 
                                                                   $sql2 = "SELECT * from tblteachers where TeacherId=".$result->TeacherId;
                                                                   $query2 = $dbh->prepare($sql2);
                                                                   $query2->execute();
                                                                   $results2=$query2->fetchAll(PDO::FETCH_OBJ);
                                                                   if($query2->rowCount() > 0)
                                                                    {?>
                                                                        <td><?php echo htmlentities($results2[0]->TeacherName);?></td>
                                                                    <?php } ?>
                                                                    <?php 
                                                                    $sql2 = "SELECT * from tblfaculty where FacultyId=".$result->FacultyId;
                                                                    $query2 = $dbh->prepare($sql2);
                                                                    $query2->execute();
                                                                    $results2=$query2->fetchAll(PDO::FETCH_OBJ);
                                                                    if($query2->rowCount() > 0)
                                                                        {?>
                                                                            <td><?php echo htmlentities($results2[0]->FacultyName);?></td>
                                                                        <?php } ?>
